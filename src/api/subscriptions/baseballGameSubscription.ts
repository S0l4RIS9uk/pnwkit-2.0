 ...
 * @return {void}
 */
export default async function baseballGameSubscription(this: Kit, channel: string, event: string, callback: Function, cluster: subscriptionCluster = subscriptionCluster.OHIO): Promise<void>  {
    ...
    newChannel.bind(`BULK_BBGAME_${event.toUpperCase()}`, callback);
