 ...
 * @return {void}
 */
export default async function citySubscription(this: Kit, channel: string, event: string, callback: Function, cluster: subscriptionCluster = subscriptionCluster.OHIO): Promise<void>  {
    ...
    newChannel.bind(`BULK_CITY_${event.toUpperCase()}`, callback);
